...
class Controller:
    # 控制参数
    MOVE_SPEED = 1 / 4 * 50  # 估算移动时间 4.5会更低
    MAX_WAIT = 3.1 * 50  # 最大等待时间 3.2 3.0 都会更低3.01 ~ 3.19
    SELL_WEIGHT = 1.43  # 优先卖给格子被部分占用的 1.45 1.4 都会更低1.41-1.44
    SELL_DEBUFF = 0.8 # 非 7 卖给89的惩罚 0.79 0.81 都会更低
    CONSERVATIVE = 1+1/MOVE_SPEED*4  # 保守程度 最后时刻要不要操作 比4.5好
